...
namespace ITHappy
{
    ...
    public class TrafficManager : Singleton<TrafficManager>
    {
        ...
        private const int k_GroupSizeSideXY = 8;
        private const int k_GroupSizeZ = 1;
        ...
        private void Move()
        {
            ...
            m_MovedTime = time;
            m_Compute.Dispatch(m_KernelIndex, m_ThreadsSideXY / k_GroupSizeSideXY, m_ThreadsSideXY / k_GroupSizeSideXY, k_GroupSizeZ);
            RequestCallbacks();
        }
        ...
        private void SetUpCompute()
        {
            ...
            m_Compute.SetBuffer(m_KernelIndex, "Rb_SplineData_4096", m_RSplinesData[2]);
            m_Compute.SetBuffer(m_KernelIndex, "Rb_SplineData_6144", m_RSplinesData[3]);
            ...
            m_ThreadsSideXY = MathExtension.GetClosestWithMult(Mathf.CeilToInt(Mathf.Sqrt(m_CarData.Length + m_CrossData.Length)), 8);
            m_ThreadsSideXY = Mathf.Max(m_ThreadsSideXY, k_GroupSizeSideXY);

            m_Compute.SetInt("Ri_SideResolution", m_ThreadsSideXY);
